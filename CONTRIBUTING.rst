...
Welcome to ``silk_basket`` contributor's guide.
...
If you experience bugs or general issues with ``silk_basket``, please have a look
...
You can help improve ``silk_basket`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``silk_basket`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``silk_basket``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n silk_basket python=3 six virtualenv pytest pytest-cov
    conda activate silk_basket
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/silk_basket.git
    cd silk_basket
...
#. Install |pre-commit|_::
   ...
   ``silk_basket`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/silk_basket
.. _issue tracker: https://github.com/<USERNAME>/silk_basket/issues
.. <-- end -->
